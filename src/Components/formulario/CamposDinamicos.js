  ...
  render() {
    return (
      <Grid>
        ...
        {this.props.plantillaSeleccionada["Nombre Plantilla"] !== undefined && (
          <Grid.Row>
            <Grid.Column width={16}>
              <Header as="h4">
                Unidad de Medida Sugerida <span className={"requerido"}>*</span>
              </Header>
              <Dropdown
                ...
                search={true}
                selection={true}
                options={this.opcionesUnidadesDeMedida}
              />
            </Grid.Column>
          </Grid.Row>
        )}
